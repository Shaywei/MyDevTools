...
class SmartHeap(Heap):
    pass
    ''' This heap is supposed to be smarter than Heap by making a clever use of _bubbledown:
        calling it on each of the n/2 elements in reversed order
    '''
